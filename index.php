      ...
      <div class="w3-third">
        <div class="w3-white w3-text-grey w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p>Электронный документооборот КСЭД</p>
            ...
            <p>Техническое сопровождение подготовки нефти</p>
            <div class="w3-light-grey w3-round-xlarge w3-small">
      ...
      <div class="w3-twothird">
        ...
        <div class="w3-container w3-card w3-white">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>По настоящее время</h6>
            <p>Аналитик данных</p>
            <hr>
          </div>
          <div class="w3-container">
            <h5 class="w3-opacity"><b>Tyumen Oil and Gaz University </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>2010 - 2015</h6>
            <p>Инженер по разработке и эксплуатации нефтяных и газовых скважин</p>
            <hr>
          </div>
          <div class="w3-container">
            <h5 class="w3-opacity"><b>Средняя школа</b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>1995 - 2005</h6>
